...
EXTRA_ARGS="--revision 15852e8c16360a2fea060d615a32b45270f8a8fc --enable-flashinfer-allreduce-fusion --mamba-radix-cache-strategy extra_buffer --max-running-requests 128 --chunked-prefill-size 16384"
