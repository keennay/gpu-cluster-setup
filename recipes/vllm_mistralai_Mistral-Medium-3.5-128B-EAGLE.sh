...
SPECULATIVE='--speculative-config {"method":"eagle","model":"mistralai/Mistral-Medium-3.5-128B-EAGLE","num_speculative_tokens":3,"max_model_len":4096}'
QUANTIZATION=""
