...
EXTRA_ARGS="--revision a099dee70ccfcd8d5dda56aaa0b60cb8ecadabc9 --enable-flashinfer-allreduce-fusion --attention-backend flashinfer --mamba-ssm-dtype bfloat16 --mamba-radix-cache-strategy extra_buffer --max-running-requests 128 --chunked-prefill-size 16384"
