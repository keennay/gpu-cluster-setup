...
SPECULATIVE='--speculative-config {"method":"dflash","model":"z-lab/gemma-4-26B-A4B-it-DFlash","num_speculative_tokens":15,"attention_backend":"flash_attn"}'
QUANTIZATION=""
NO_PREFIX_CACHE=""
SCRIPT_DIR=""
REASONING_PARSER_PLUGIN="${SCRIPT_DIR:+$SCRIPT_DIR/plugins/super_v3_reasoning_parser.py}"
EXTRA_ARGS="--attention-backend triton_attn --max-num-batched-tokens 32768"
