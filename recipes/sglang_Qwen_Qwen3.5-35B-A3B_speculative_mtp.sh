...
EXTRA_ARGS="--revision 59d61f3ce65a6d9863b86d2e96597125219dc754 --enable-flashinfer-allreduce-fusion --mamba-radix-cache-strategy extra_buffer --max-running-requests 128 --chunked-prefill-size 16384"
