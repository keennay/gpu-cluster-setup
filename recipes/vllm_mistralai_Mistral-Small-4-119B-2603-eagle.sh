...
SPECULATIVE='--speculative-config {"method":"eagle","model":"mistralai/Mistral-Small-4-119B-2603-eagle","num_speculative_tokens":3,"max_model_len":8192}'
QUANTIZATION=""
