...
EXTRA_ARGS="--revision 2fc06364715b967f1860aea9cf38778875588b17 --enable-flashinfer-allreduce-fusion --mamba-radix-cache-strategy extra_buffer --max-running-requests 128 --chunked-prefill-size 16384"
