...
EXTRA_ARGS="--default-chat-template-kwargs {\"enable_thinking\":true} --moe-backend triton --reasoning-parser poolside_v1 --max-num-batched-tokens 32768"
